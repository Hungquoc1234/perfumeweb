<?php
    ...
    if(isset($_POST['searchKeyword']) and !empty($_POST['searchKeyword'])){
        mysqli_close($con);
        header('Location: HomePageAdminSearch.php?keyword='.$_POST['searchKeyword'].'');
        die();
    }
?>
<!DOCTYPE html>
        ...
        <div class="body">
            <div class="content-container">
                ...
                <div class="products-container">
                    <?php
                        $result = mysqli_query($con, "select * from product where name like '%$searchKeyword%' or supplier like '%$searchKeyword%' or sex like '%$searchKeyword%' or scent like '%$searchKeyword%' order by id desc");
